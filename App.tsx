...
import { Globe, GraduationCap, Users, ShieldCheck, ArrowRight } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans selection:bg-emerald-500/30 overflow-x-hidden relative">
      ...
      <main className="relative z-10 max-w-4xl mx-auto px-4 py-12">
        {error && (
          <div className="mb-8 p-4 bg-red-950/30 border border-red-500/20 rounded-xl flex items-center text-red-200 text-sm backdrop-blur-sm">
        ...
        {!analysisResult ? (
          <div className="space-y-8 animate-fade-in">
             <div className="text-center mb-10">
               <h2 className="text-3xl md:text-5xl font-bold text-white mb-4 tracking-tight leading-tight">
                 What level would a college <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-teal-500">coach put you at today?</span>
               </h2>
             ...
             <div className="mt-24 border-t border-white/5 pt-12">
                <div className="text-center mb-10">
                  <div className="inline-flex items-center justify-center px-3 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-[10px] font-bold uppercase tracking-widest mb-3">
                    Powered by Warubi Sports
                  </div>
                  <h3 className="text-2xl font-bold text-white mb-4">Decade of Excellence. Global Reach.</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto mb-10">
                    <div className="bg-slate-900/40 p-5 rounded-2xl border border-white/5 text-center hover:bg-slate-900/60 transition-colors group">
                       <div className="w-10 h-10 mx-auto bg-slate-800 rounded-full flex items-center justify-center mb-3 group-hover:bg-emerald-500/20 transition-colors">
                          <GraduationCap className="w-5 h-5 text-slate-400 group-hover:text-emerald-400" />
                       </div>
                       <div className="text-3xl font-bold text-white mb-1 group-hover:text-emerald-400 transition-colors">1,000+</div>
                       <div className="text-xs text-slate-500 font-mono uppercase tracking-wider">College & Semi-Pro Placements</div>
                    </div>
                     <div className="bg-slate-900/40 p-5 rounded-2xl border border-white/5 text-center hover:bg-slate-900/60 transition-colors group">
                       <div className="w-10 h-10 mx-auto bg-slate-800 rounded-full flex items-center justify-center mb-3 group-hover:bg-emerald-500/20 transition-colors">
                          <Users className="w-5 h-5 text-slate-400 group-hover:text-emerald-400" />
                       </div>
                       <div className="text-3xl font-bold text-white mb-1 group-hover:text-emerald-400 transition-colors">500+</div>
                       <div className="text-xs text-slate-500 font-mono uppercase tracking-wider">Licensed Coaches Network</div>
                    </div>
                     <div className="bg-slate-900/40 p-5 rounded-2xl border border-white/5 text-center hover:bg-slate-900/60 transition-colors group">
                       <div className="w-10 h-10 mx-auto bg-slate-800 rounded-full flex items-center justify-center mb-3 group-hover:bg-emerald-500/20 transition-colors">
                          <ShieldCheck className="w-5 h-5 text-slate-400 group-hover:text-emerald-400" />
                       </div>
                       <div className="text-xl font-bold text-white mb-1 pt-1.5 group-hover:text-emerald-400 transition-colors">TRUSTED</div>
          ...
          <AnalysisResultView result={analysisResult} profile={profile!} onReset={handleReset} />
        )}
      </main>

      <footer className="relative z-10 py-8 text-center text-[10px] text-slate-600 font-mono print:hidden">
